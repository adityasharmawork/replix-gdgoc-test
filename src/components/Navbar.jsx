    ...
    <header className="bg-slate-800/60 backdrop-blur sticky top-0 z-40">
      <div className="max-w-6xl mx-auto flex items-center gap-6 p-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="text-xl font-semibold">Replix <span className="text-accent">- GDGoC-AEC</span></div>
            <div className="text-xs text-slate-400">Core Team Selection Test Dashboard</div>
          </div>
        </div>
